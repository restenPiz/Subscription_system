                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-basic-single" name="user_id" style="width:100%">
                                            <option value="{{ $subscription->user_id }}">{{ $subscription->user_id }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-basic-single" name="stripe_status" style="width:100%">
                                            <option value="{{$subscription->stripe_status}}">{{$subscription->stripe_status}}</option> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputUsername1" value="{{$subscription->name}}"name="name" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Stripe_price</label>
                                        <input type="text" class="form-control" id="exampleInputUsername1" name="stripe_price" value="{{$subscription->stripe_price}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Stripe_id</label>
                                        <input type="text" class="form-control" id="exampleInputUsername1" name="stripe_id" value="{{$subscription->stripe_id}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Quantity</label>
                                        <input type="text" class="form-control" id="exampleInputUsername1" name="quantity" value="{{$subscription->quantity}}"
                                            required>
                                    </div>
                                </div>
                            </div>
